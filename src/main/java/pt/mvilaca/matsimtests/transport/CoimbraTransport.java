...
//		String gtfsFolder = "data/transport/coimbra/test2";
		...
		String scheduleFileWithTransports = "scenarios/coimbra/scheduleWithTransports.xml";
		
		String inputNetwork = "scenarios/coimbra/network.xml";
		String networkWithTransports = "scenarios/coimbra/networkWithTransports.xml";
