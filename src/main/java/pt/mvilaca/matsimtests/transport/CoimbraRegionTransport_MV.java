...
//		String gtfsFolder = "data/transport/coimbra/test2";
		...
		String scheduleFile = "scenarios/coimbraRegion/schedule.xml";
		String vehicleFile = "scenarios/coimbraRegion/vehicle.xml";
		
		
		String scheduleFileWithTransports = "scenarios/coimbraRegion/scheduleWithTransports_MV.xml";
		
		String inputNetwork = "scenarios/coimbraRegion/network.xml";
		String networkWithTransports = "scenarios/coimbraRegion/networkWithTransports_MV.xml";
