...
public class CoimbraTransport_MV {
...
//		String gtfsFolder = "data/transport/coimbra/test2";
		...
		String scheduleFileWithTransports = "scenarios/coimbra/scheduleWithTransports_MV.xml";
		
		String inputNetwork = "scenarios/coimbra/network.xml";
		String networkWithTransports = "scenarios/coimbra/networkWithTransports_MV.xml";
