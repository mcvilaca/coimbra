...
public class RandomSyntheticPopulation_v1 {

	public static void main(String[] args) {
		int numberOfHomes = 20;
		int numberOfWorks = 3;
		...
		populationWriter.write("scenarios/aveiro_v1/population.xml");
		
		FacilitiesWriter facilitiesWriter = new FacilitiesWriter(scenario.getActivityFacilities());
		facilitiesWriter.write("scenarios/aveiro_v1/facilities.xml");
	}
