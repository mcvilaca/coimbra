...
public class SyntheticRealPopulationCoimbra {
public static void main(String[] args) throws IOException, ParseException {
		
		Config config = ConfigUtils.createConfig();
		config.network().setInputFile("scenarios/coimbraRegion/network.xml");
...
//		Population population = scenario.getPopulation();
		...
		populationWriter.write("scenarios/coimbraRegion/population.xml");
		
		FacilitiesWriter facilitiesWriter = new FacilitiesWriter(scenario.getActivityFacilities());
		facilitiesWriter.write("scenarios/coimbraRegion/facilities.xml");
	}
